/*
     ТС, среднего расхода топлива, объем топливного бака, скорость
...
namespace Cars
{
    ...
    public class PassengerCar:Car
    {
        ...
        public float PowerReserve(int passengerCount)
        {
    ...
    public partial class Form1:Form
    {
        public Form1()
        {
            ...
            // Запас хода
            var powerReserve = passengerCar.PowerReserve(0); // Без пассажиров
            powerReserve = passengerCar.PowerReserve(1); // С 1 пассажиром
            powerReserve = passengerCar.PowerReserve(2); // С 3 пассажирами
